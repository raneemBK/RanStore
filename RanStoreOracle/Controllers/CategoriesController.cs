...
namespace RanStore.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(ModelContext context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ImageFile")] Category category)
        {
            if (ModelState.IsValid)
            {
                if (category.ImageFile != null)
                {
                    ...
                    var fileName = Guid.NewGuid().ToString() + "_" + category.ImageFile.FileName;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,Imagepath")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
